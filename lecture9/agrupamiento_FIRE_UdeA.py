...
candidate_paths = [
    Path('lecture8/dataset_para_modelado.csv'),
    Path('../lecture8/dataset_para_modelado.csv'),
    Path('dataset_para_modelado.csv'),
    Path('lecture9/dataset_para_modelado.csv'),
]
...
for path in candidate_paths:
    ...
    raise FileNotFoundError(
        f'No se encontró dataset_para_modelado.csv. Rutas intentadas: {candidate_paths}'
    )
...
# - Validaremos después si clustering lo recupera bien
...
print('=== ÍNDICE DE SEPARABILIDAD (Silhueta teórica) ===')
